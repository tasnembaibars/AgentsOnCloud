...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 10, 2022 at 02:55 PM
...
--
-- Constraints for table `whichlist`
--
ALTER TABLE `whichlist`
  ADD CONSTRAINT `whichlist_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `whichlist_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
